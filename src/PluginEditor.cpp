...
void DrumsDemixEditor::buttonClicked(juce::Button* btn)
{
    ...
    if (btn == &testButton) {
        ...
        auto modelFilePath = "C:/Users/Riccardo/OneDrive - Politecnico di Milano/Desktop/NEURAL PLUG IN/neural_plug_in/model.json";
        ...
        juce::File file = juce::File("C:/Users/Riccardo/OneDrive - Politecnico di Milano/Desktop/ReverbTest.wav");
...
void DrumsDemixEditor::loadModel(std::ifstream& jsonStream, RTNeural::ModelT<float, 1, 1, RTNeural::LSTMLayerT<float, 1, 8>, RTNeural::DenseT<float, 8, 1>>& model)
{
