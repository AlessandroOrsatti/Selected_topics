...
private:
    ...
    // compute the elapsed time since lastNoteOnTime and the sent message
    // and add that onset interval to the IOI model 
    void learnIOI(juce::MidiMessage& noteOnMsg);
