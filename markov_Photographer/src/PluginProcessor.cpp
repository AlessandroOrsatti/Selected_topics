...
#endif
, markovModel{}, noteDurationModel{}, lastNoteOnTime{0}, modelPlayNoteTime{0}, chordDetect{100}, elapsedSamples{0}, learningMode{true}
{
...
void MidiMarkovProcessor::learnIOI(juce::MidiMessage& noteOnMsg)
{
    if (learningMode){
      ...
      if (interOnsetInt < getSampleRate() * 2 && 
        ...
        //std::cout << "IOI " << interOnsetInt << std::endl;
